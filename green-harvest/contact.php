...
<selection>
    <div class="registration-box">
        <form action="contact.php" method="post">
            ...
            <div class="input-box">
                <span class="icon"><i class="fa-solid fa-user fa-beat" style="color: #212529;"></i></span>
                <input type="text" name="name" required>
                <label>Name</label>
            </div>

            <div class="input-box">
                <span class="icon"><i class="fa-solid fa-phone fa-shake" style="color: #212529;"></i></span>
                <input type="text" name="mobile" required>
                <label>Mobile Number</label>
            </div>

            <div class="input-box">
                <span class="icon"><i class="fa-solid fa-envelope fa-beat-fade" style="color: #212529;"></i></span>
